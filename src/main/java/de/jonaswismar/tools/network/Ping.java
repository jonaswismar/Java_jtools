...
import de.jonaswismar.tools.network.ping.PingOptions;
import de.jonaswismar.tools.network.ping.PingResult;
import de.jonaswismar.tools.network.ping.PingStats;
import de.jonaswismar.tools.network.ping.PingTools;
...
public class Ping {
     ...
     *
     * Note that a lookup is not performed here so that we do not accidentally
     * perform a network request on the UI thread.
     *
     ...
     *
     * @param delayBetweenScansMillis - the timeout for each ping in
     * milliseconds
     * @return this object to allow chaining
     */
    ...
    /**
     * Set the address string which will be resolved to an address by
    ...
    /**
     * Perform a synchronous ping and return a result, will ignore number of
     * times.
     *
     * Note that this should be performed on a background thread as it will
