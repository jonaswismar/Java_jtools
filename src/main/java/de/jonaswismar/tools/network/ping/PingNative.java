...
import de.jonaswismar.tools.network.IPTools;
...
public class PingNative {
     ...
     *
     * --- 127.0.0.1 activity_ping statistics --- 4 packets transmitted, 4
     * received, 0% packet loss, time 0ms rtt min/avg/max/mdev =
     * 0.251/0.285/0.300/0.019 ms
     *
     * PING 192.168.0.2 (192.168.0.2) 56(84) bytes of data.
     *
     * --- 192.168.0.2 activity_ping statistics --- 1 packets transmitted, 0
     * received, 100% packet loss, time 0ms
     *
     * # activity_ping 321321. activity_ping: unknown host 321321.
     *
