...
public class WakeOnLan {
    ...
    /**
     * Sets the number of packets to send, this is to overcome the flakiness of
     * networks
     *
    ...
    /**
     * Synchronous call of the wake method. Note that this is a network request
    ...
    /**
     * Asynchronous call of the wake method. This will be performed on the
     * background thread and optionally fire a listener when complete, or when
     * an error occurs
     *
